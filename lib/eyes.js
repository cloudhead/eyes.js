...
var eyes = {
    defaults: {
        styles: {                 // Styles applied to stdout
            ...
            special: 'blue',      // null, undefined...
            string:  'green',
            number:  'magenta',
            bool:    'blue',      // true false
            regexp:  'green',     // /\d+/
            array:   'bold'       // [] (brackets part)
        },
        hideFunctions: false,
    ...
    print: function (str, label, options) {
        ...
        return options.writer.write.call(options.writer, (label ?
...
for (var e in eyes) exports[e] = eyes[e];
...
function merge(/* variable args */) {
    ...
    objs.forEach(function (o) {
        for (var s in o.styles) { target.styles[s] = o.styles[s] || target.styles[s] }
        target.hideFunctions = o.hideFunctions || target.hideFunctions;
        target.writer = o.writer || target.writer;
        target.maxLength = o.maxLength || target.maxLength;
    });
    return target;
}
