...
function stringify(obj, options) {
    ...
    result = (function (obj) {
        switch (typeOf(obj)) {
            case "string"   : obj = stringifyString(obj.length === 1 ? "'" + obj + "'"
                                                                     : '"' + obj + '"');
            ...
            case "array"    : return stringifyArray(obj,  options);
            case "object"   : return stringifyObject(obj, options);
        }
    })(obj);
...
// in the array.
function stringifyArray(ary, options) {
    var out = [];
